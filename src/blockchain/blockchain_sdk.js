...
function doInvoke(params){
    return new Promise(function(resolve, reject){
        ...
        try{
            logHelper.logEntryAndInput(logger, 'doInvoke - modified', params.requestSpec);
            ...
            chainAsync.getMemberAsync(user)
            .then(function(member){
                logHelper.logMessage(logger, "requestSpecc :" +requestspec)
                ...
                tx.on('error', function (err) {
                    logHelper.logError(logger, 'doInvoke', '(then)Could not perform invoke ',err);
